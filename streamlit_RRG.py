...
def create_rrg_chart(data, benchmark, sectors, sector_names, universe, timeframe):
    print(f"Creating chart for {universe} universe with {timeframe} timeframe")
    ...
    try:
        ...
        for sector in sectors:
            try:
                ...
                print(f"Error calculating RRG values for {sector}: {str(e)}")

        print(f"RRG data shape: {rrg_data.shape}")
